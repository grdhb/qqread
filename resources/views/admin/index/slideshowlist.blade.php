        ...
        <div class="layui-col-md12">
            <div class="layui-card">
                ...
                <div class="layui-card-header">
                    ...
                    <button class="layui-btn" onclick="xadmin.open('添加用户','/admin/slideshow',600,400)"><i class="layui-icon"></i>添加</button>
                </div>
                <div class="layui-card-body ">
                    <table class="layui-table layui-form">
                        ...
                        <tr>
                            ...
                            <td>{{$v->id}}</td>
                            <td><img width="200" height="60" src="/upload/{{$v->file}}"></td>
                            <td>{{$v->url}}</td>
                            <td>{{$v->created_at}}</td>
                            @if($v->show==1)
                            <td class="td-status">
                            ...
                            @else
                                ...
                                <td class="td-manage">
                                    <a onclick="member_stop(this,'{{$v->id}}')" href="javascript:;"  title="未启用">
                                        <i class="layui-icon">&#xe601;</i>
                                    </a>
                            @endif
