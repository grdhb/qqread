...
<head>
    ...
    <!-- <link rel="stylesheet" href="/xadmin/css/theme5.css"> -->
...
<div class="left-nav">
    <div id="side-nav">
        <ul id="nav">
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="小说">&#xe6b4;</i>
                    <cite>小说</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('添加小说','/admin/fictions')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加小说</cite></a>
                    </li>
                </ul>
            ...
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="添加作品">&#xe6b4;</i>
                    <cite>添加作品</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('添加作品','/admin/production')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>添加作品</cite></a>
                    </li>
                </ul>
            ...
            <li>
                <a href="javascript:;">
                    <i class="iconfont left-nav-li" lay-tips="轮播图">&#xe6b4;</i>
                    <cite>轮播图</cite>
                    <i class="iconfont nav_right">&#xe697;</i></a>
                <ul class="sub-menu">
                    <li>
                        <a onclick="xadmin.add_tab('管理轮播图','/admin/slideshowlist')">
                            <i class="iconfont">&#xe6a7;</i>
                            <cite>管理轮播图</cite></a>
                    </li>
                </ul>
